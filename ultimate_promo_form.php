...
<form id="promo_form" action="" method="POST" >
     ...
     <div class="promo-enter"> <label for="promo_code"><?php echo $promolabel; ?></label><br>

      <input type="text" value="" name="promo_code" id="promo_code" /></div>

      

      <div class="promo-enter"><label class="promo_email" for="email"><?php echo $emaillabel; ?></label>

      <input type="text" value="" name="email" id="email" /><br></div>

      <input type="hidden" value="<?php echo $id;?>" name="promo_ids">

      <div class="promo_submit"><input type="submit" value="Submit"  name="Ultimate_promo_submit" id="Ultimate_promo_submit" /></div>
